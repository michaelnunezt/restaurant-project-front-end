  ...
  return (
    <div style={{ position: "absolute", top: 0, width: "100%", zIndex: 1 }}>
      <Carousel className="carousel" slide={true}>
        <Carousel.Item>
          <img className="img-carousel" src={Home1} alt="First slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="img-carousel" src={Home2} alt="Second slide" />
        </Carousel.Item>
        <Carousel.Item>
          <img className="img-carousel" src={Home3} alt="Third slide" />
        </Carousel.Item>
      </Carousel>
    </div>
  );
